...
//console.log(calculateTip(prompt("How much do you want to tip?"), prompt("total bill")))
...
alert("you should tip $" + calculateTip(prompt("How much do you want to tip?"), prompt("total bill")))
